...
public class frmLoggin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 320));
    ...
    public void accesoAlSistema() throws SQLException, NoSuchAlgorithmException
    {
        String nU, pas;
        ...
        {//inciio else
            ...
            try
            {
                ...
                PreparedStatement pstmx=(PreparedStatement)con.getConnection().prepareStatement("SELECT idUsuario, contraseña FROM usuario WHERE  usuario='"+nU+"' ");
                ...
                {          
                    pstmx=(PreparedStatement) con.getConnection().prepareStatement("SELECT idUsuario, contraseña FROM usuario WHERE  usuario='"+nU+"' AND contraseña = md5('"+pas+"');");
                    resultado = pstmx.executeQuery(); 
                    resultado.last();
                    if (resultado.getRow()<=0) {
                        ...
                        while(resultado.next())
                        {
                            ...
                            cUser= resultado.getString("idUsuario");fPrin.cUser=cUser;//le enviamos a la variable globar cUser del formulario padre el nombre del usuario almacendao en cUser                            
