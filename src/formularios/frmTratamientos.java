...
public class frmTratamientos extends javax.swing.JInternalFrame {
    ...
    private void updateTabla() {
        String[] columNames = {"Id_Tratamiento", "Nombre Tratamiento", "Tarifa", "Servicio"};
        //usamos la funcion
       ...
       try
        {
            ...
            {                                  
                ...
                con.getConnection().prepareStatement("SELECT MAX(IdTratamiento) as codigo FROM tratamiento");
    ...
    public void guardarTratamiento() throws SQLException
    {
        ...
        if (txtNombreTratamiento.getText().equals("")) {
            ...
            String sql = "SELECT IdServicio FROM servicios WHERE nomServicio = " + v + "";
        ...
        try
        {
           ...
           //BUCLE QUE PERMITE LLENAR EL COMBO
            while (res.next())
            {
                ...
                jcServicios.addItem (res.getString("nomServicio"));
            }
            res.close();
        }
        catch(SQLException e)
