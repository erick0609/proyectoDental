...
public class usuarios {
            ...
            String modE, String modM, String repor, String modUs, String modDE, String manBD)
    {
        try
        {
            ...
            con.getConnection().prepareStatement("insert into " + " usuario(IdUsuario, nombres, apellidos, "
    ...
    public Object[][]getDatos()
    {
        ...
        {
            PreparedStatement pstm=(PreparedStatement)
            con.getConnection().prepareStatement("SELECT count(1) as total FROM usuario");
        ...
        {
            PreparedStatement pstm=(PreparedStatement)
            con.getConnection().prepareStatement("SELECT IdUsuario, nombres, apellidos, nombreUsuario, contrasenia FROM usuario");
            ResultSet res=pstm.executeQuery();
    ...
    public void eliminarUsuarios(String codUsuario)
    {
        ...
        {
            int rows_update=0;
            PreparedStatement pstm=con.getConnection().prepareStatement("DELETE usuario.* FROM usuario WHERE IdUsuario='"+codUsuario+"'");
    ...
    public void modificarUsuarios(String codU, String nom, String ap, String nomU,  String cont, String modP, String gestionC, String resC, String realC, String modS, String modT, String modE, String modM, String repor, String modUs, String modDE, String manBD)
    {
        ...
        {
            PreparedStatement pstm=(PreparedStatement)
            con.getConnection().prepareStatement("UPDATE usuario SET nombres='"+nom+"',  apellidos='"+ap+"'"
