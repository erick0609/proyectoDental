...
public class gestionCitas {
    ...
    public Object[][]getDatos1()
    {
        ...
        try
        {
            ...
            con.getConnection().prepareStatement("SELECT count(1) as total FROM citas WHERE estado=1 ORDER BY fecha,hora ASC");//cuenta el total de registros de la tabla Citas que esten vigentes
        ...
        {
            PreparedStatement pstm=(PreparedStatement)
            con.getConnection().prepareStatement("SELECT * FROM citas WHERE estado=1 ORDER BY fecha,hora ASC");
            ResultSet res=pstm.executeQuery();
    ...
    public Object[][]getDatos2()
    {
        ...
        {
            PreparedStatement pstm=(PreparedStatement)
            con.getConnection().prepareStatement("SELECT count(1) as total FROM citas WHERE estado=0 ORDER BY fecha,hora ASC");//cuenta el total de registros de la tabla Citas que esten anuladas
            ResultSet res=pstm.executeQuery();
            res.next();
            registros = res.getInt("total");
            res.close();
        ...
        {
            PreparedStatement pstm=(PreparedStatement)
            con.getConnection().prepareStatement("SELECT * FROM citas WHERE estado=0 ORDER BY fecha,hora ASC"); // estado=0 significa cita anulada
            ResultSet res=pstm.executeQuery();
    ...
    public Object[][]getDatos3()
    {
        ...
        {
            PreparedStatement pstm=(PreparedStatement)
            con.getConnection().prepareStatement("SELECT * FROM citas WHERE estado=2 ORDER BY fecha DESC"); // estado=2 significa cita vencida
            ResultSet res=pstm.executeQuery();
